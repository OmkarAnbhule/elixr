...
export default function Footer() {
    return (
        <div className='bg-black pt-20 w-full h-full min-h-[600px] flex justify-center gap-10 md:gap-20 items-center flex-col'>
            ...
            <div className='w-11/12 h-fit flex justify-center items-center'>
                <div className='bg-gradient-to-l from-violet-500 to-fuchsia-300 bg-clip-text text-transparent text-xl md:text-3xl w-1/2 md:w-1/3 font-bold'>
                    ELIXR
                </div>
                <div className='hidden md:flex justify-around items-center w-1/3'>
                    {
                        ['About', 'Team', 'Contact'].map((item, index) => (
                            <motion.p
                                ...
                                className='text-white text-lg hover:underline-offset-1' key={index}>{item}</motion.p>
                        ))
                    }
                </div>
                <div className='w-1/2 md:w-1/3 flex justify-end gap-3 items-center'>
            ...
            <div className='md:hidden pb-5 m-0 flex justify-around items-center w-full h-fit'>
                {
                    ['About', 'Team', 'Contact'].map((item, index) => (
                        <motion.p
                            initial={{ opacity: 0, y: 100 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            transition={{ duration: 1 }}
                            className='text-white text-lg hover:underline' key={index}>{item}</motion.p>
                    ))
                }
            </div>
        </div>
